function [p]=setprior(Theta)
 % prior from uniform dist, params 10-15
 lb=[0,0,0,0,0,0];
 ub=[1,1,1,1,1,1];
 ...
 P1=normpdf(Theta(1),2,0.25);
 P2=normpdf(Theta(2),2,0.25);
 P3=normpdf(Theta(3),2,0.25);
 
 
 % prior from gamma dist
 para1=[5,5,1.5,0.2,0.2,0.2];
 ...
 P16=exp(lnpdfig(Theta(16),0.5,4));
 P17=exp(lnpdfig(Theta(17),0.5,4));
 P18=exp(lnpdfig(Theta(18),0.5,4));
